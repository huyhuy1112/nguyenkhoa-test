...
$languageStrings = array(
	...
	'LBL_NK_SYSTEM_INTEGRATIONS' => 'System Integrations',
	'LBL_NK_SYSTEM_INTEGRATIONS_DESC' => 'Configure MISA, Google Sheet and e-commerce connections. Adapters are ready for API implementation.',
	'LBL_NK_NOTIFICATION_PREFS' => 'Notification preferences',
	'LBL_NK_NOTIFICATION_PREFS_DESC' => 'Turn notification types on or off for your account.',
	'LBL_NK_LEAD_ROUND_ROBIN' => 'Lead Round Robin',
	'LBL_NK_LEAD_ROUND_ROBIN_DESC' => 'View the Sale pool and rotation cursor for new Lead assignment (stages 1.1 / 1.2).',
	'LBL_NK_INTEGRATION_HUB' => 'Integration Hub',
	'LBL_NK_INTEGRATION_HUB_DESC' => 'Manage connections and data sync between CRM and external systems.',
	'LBL_NK_INTEGRATION_HUB_LEGACY' => 'Legacy configuration UI',
	'LBL_NK_INTEGRATION_HUB_ADD' => 'Add connection',
	'LBL_NK_INTEGRATION_HUB_CONNECTIONS' => 'Connections',
	'LBL_NK_INTEGRATION_HUB_ACTIVITY' => 'Activity log',
	'LBL_NK_INTEGRATION_HUB_DETAIL' => 'Connection detail',
	'LBL_NK_INTEGRATION_HUB_FLOW' => 'Data sync flow',
	'LBL_NK_INTEGRATION_HUB_VIEW_ALL' => 'View all connections',
	'LBL_NK_INTEGRATION_HUB_STAT_TOTAL' => 'Total connections',
	'LBL_NK_INTEGRATION_HUB_STAT_ACTIVE' => 'Active',
	'LBL_NK_INTEGRATION_HUB_STAT_WARNING' => 'Warning',
	'LBL_NK_INTEGRATION_HUB_STAT_ERROR' => 'Error',
	'LBL_NK_INTEGRATION_HUB_STAT_SYNC_TODAY' => 'Synced today',
	'LBL_NK_INTEGRATION_HUB_FILTER_ALL' => 'All statuses',
	'LBL_NK_INTEGRATION_HUB_SEARCH' => 'Search connections...',
	'LBL_NK_INTEGRATION_HUB_CONFIGURE' => 'Configure',
	'LBL_NK_INTEGRATION_HUB_TEST' => 'Test connection',
	'LBL_NK_INTEGRATION_HUB_DISCONNECT' => 'Disconnect',
	'LBL_NK_HUB_STATUS_ACTIVE' => 'Active',
	'LBL_NK_HUB_STATUS_WARNING' => 'Warning',
	'LBL_NK_HUB_STATUS_ERROR' => 'Connection error',
	'LBL_NK_HUB_STATUS_INACTIVE' => 'Not connected',
	'LBL_SETTINGS_INDEX_INTRO' => 'Manage users, permissions, modules, automation, and integrations from one unified settings workspace.',
	'LBL_NK_INTEG_ENABLED' => 'Enable connection',
	'LBL_NK_INTEG_BASE_URL' => 'API URL / Endpoint',
	'LBL_NK_INTEG_USERNAME' => 'Username',
	'LBL_NK_INTEG_API_KEY' => 'API key / Token',
	'LBL_NK_INTEG_PASSWORD' => 'Password',
	'LBL_NK_INTEG_SHEET_URL' => 'Spreadsheet URL or ID',
	'LBL_NK_INTEG_SHEET_RANGE' => 'Sheet tab / range',
	'LBL_NK_INTEG_SA_JSON' => 'Service Account JSON',
	'LBL_NK_INTEG_SA_PLACEHOLDER' => 'Paste full service_account JSON. Leave blank to keep existing.',
	'LBL_NK_INTEG_COLUMN_MAP' => 'Column map (JSON)',
	'LBL_NK_INTEG_CONFIGURED' => 'configured',
	'LBL_NK_INTEG_SECRET_PLACEHOLDER' => 'Leave blank to keep existing',
	'LBL_NK_INTEG_LAST_SYNC' => 'Last sync',
	'LBL_NK_INTEG_LAST_ERROR' => 'Last error',
	'LBL_NK_INTEG_ADVANCED' => 'Advanced (JSON, column map)',
	'LBL_NK_INTEG_TEST' => 'Test connection',
	'LBL_NK_INTEG_SAVED' => 'Integration settings saved.',
	'LBL_NK_INTEG_ZALO_APP_ID' => 'App ID',
	'LBL_NK_INTEG_ZALO_OA_ID' => 'OA ID',
	'LBL_NK_INTEG_ZALO_OA_ID_HINT' => 'Official Account ID (not App ID)',
	'LBL_NK_INTEG_ZALO_SECRET' => 'Secret Key',
	'LBL_NK_INTEG_ZALO_REFRESH' => 'Refresh Token',
	'LBL_NK_INTEG_ZALO_REFRESH_PLACEHOLDER' => 'Paste refresh token or use Connect Zalo OA',
	'LBL_NK_INTEG_ZALO_CONNECT' => 'Connect Zalo OA',
	'LBL_NK_INTEG_ZALO_CALLBACK' => 'Callback URL (add in Zalo Developers)',
	'LBL_NK_INTEG_ZALO_CALLBACK_HINT' => 'Register this URL as Callback / Redirect URI on developers.zalo.me',
	'LBL_NK_INTEG_ZALO_WEBHOOK' => 'Webhook URL (send messages to Leads)',
	'LBL_NK_INTEG_ZALO_WEBHOOK_HINT' => 'Use this URL in OA script webhook to push answers into Leads',
	'LBL_NK_INTEG_ZALO_EXPIRES' => 'Access token expires',
