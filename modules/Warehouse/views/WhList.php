...
class Warehouse_WhList_View extends Vtiger_Index_View {
	...
	public function preProcess(Vtiger_Request $request, $display = true) {
		Warehouse_WhMgmt_Helper::assignInventoryContext($this, $request, 'WhList', 'WarehouseWhList');
	...
	public function process(Vtiger_Request $request) {
		...
		$viewer->view('WhList.tpl', $request->getModule());
	}
}
