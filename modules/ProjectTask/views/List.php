<?php
/*+**********************************************************************************
 * ProjectTask List — MANAGEMENT dashboard shell (sidebar + topbar + padded content).
 ************************************************************************************/

class ProjectTask_List_View extends Vtiger_List_View {
	...
	public function getHeaderCss(Vtiger_Request $request) {
		...
		$cssFileNames = array(
			'~layouts/v7/modules/Project/resources/ProjectMkTaskDetail.css',
		);
