...
class Vtiger_Dashboard_View extends Vtiger_Index_View {
	...
	public function getHeaderScripts(Vtiger_Request $request) {
		...
		$jsFileNames = array(
			...
			'~/libraries/jquery/vtchart.js',
			'~layouts/'.Vtiger_Viewer::getDefaultLayoutName().'/modules/Vtiger/resources/DashBoardChartsTheme.js?mk_v=20260603_dash5',
			...
			'~layouts/'.Vtiger_Viewer::getDefaultLayoutName().'/modules/Vtiger/resources/dashboards/DashboardWidgetRegistry.js?mk_v=20260603_dash5',
