...
class Vtiger_Dashboard_View extends Vtiger_Index_View {
	...
	public function postProcess(Vtiger_Request $request) {
		// DashBoardPreProcess + DashBoardContents already close mk-dash shell; skip IndexPostProcess (3 extra </div> breaks DOM → footer mid-page, widgets below footer).
	...
	public function getHeaderScripts(Vtiger_Request $request) {
		...
		$jsFileNames = array(
			...
			'~layouts/'.Vtiger_Viewer::getDefaultLayoutName().'/modules/Vtiger/resources/dashboards/DashboardWidgetRegistry.js',
