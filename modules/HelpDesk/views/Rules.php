...
class HelpDesk_Rules_View extends Vtiger_Index_View {
	...
	public function getHeaderScripts(Vtiger_Request $request) {
		...
		$jsFileNames = array(
			'~layouts/v7/modules/HelpDesk/resources/MkTagRuleEngineStore.js?mk_v=20260925_rulelogic1',
			'~layouts/v7/modules/HelpDesk/resources/MkTagRuleEngine.js?mk_v=20260925_rulelogic1',
	...
	public function getHeaderCss(Vtiger_Request $request) {
		...
		$cssFileNames = array(
			...
			'~layouts/v7/modules/HelpDesk/resources/MkTagRuleEngine.css?mk_v=20260925_rulelogic1',
		);
