	...
	*/
	...
	function setRelationTables($secmodule){
		$rel_tables = array (
			...
			// Unified Products & Services module uses the generic entity relation table.
			"ProductsServices" => array("vtiger_crmentityrel"=>array("crmid","relcrmid"),"vtiger_potential"=>"potentialid"),
