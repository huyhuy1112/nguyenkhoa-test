{* Documents MANAGEMENT: vtiger edit form without legacy chrome / duplicate header. *}
{strip}
<div class="editViewPageDiv viewContent mk-documents-edit-form-root">
	<div class="col-sm-12 col-xs-12 content-area full-width">
		<form class="form-horizontal recordEditView" id="EditView" name="edit" method="post" action="index.php" enctype="multipart/form-data">
			<div class="editViewHeader mk-documents-edit-form-header-legacy">
				<div class="row">
			...
			<div class="modal-overlay-footer clearfix mk-documents-edit-footer">
				<div class="row clearfix">
					<div class="textAlignCenter col-lg-12 col-md-12 col-sm-12">
						<button type="submit" class="btn btn-success saveButton mk-documents-edit-btn-save">{vtranslate('LBL_SAVE', $MODULE)}</button>
						<a class="cancelLink mk-documents-edit-btn-cancel" href="javascript:history.{if $DUPLICATE_RECORDS}go(-2){else}back(){/if}" type="reset">{vtranslate('LBL_CANCEL', $MODULE)}</a>
					</div>
				</div>
			</div>
		</form>
