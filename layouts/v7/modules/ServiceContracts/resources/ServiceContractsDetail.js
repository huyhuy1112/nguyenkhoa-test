/**
 * ServiceContracts Detail (Sales): related-tab badge refresh only. No layout DOM moves.
 * Scope: body[data-module="ServiceContracts"][data-view="Detail"][data-app="SALES"]
 */
(function ($) {
	'use strict';
