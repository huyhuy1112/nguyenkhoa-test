{* ServiceContracts Detail header: Contacts hero shell. *}
{strip}
{if (isset($SELECTED_MENU_CATEGORY) && $SELECTED_MENU_CATEGORY eq 'SALES') || (isset($smarty.get.app) && $smarty.get.app eq 'SALES')}
<div class="detailview-header-block mk-sc-detail-hero-strip">
	<div class="detailview-header mk-sc-hero mk-sc-detail-hero">
		<div class="mk-sc-detail-hero__row">
			{include file="DetailViewHeaderTitle.tpl"|vtemplate_path:$MODULE}
			{include file="DetailViewActions.tpl"|vtemplate_path:$MODULE}
		</div>
		<div class="mk-sc-detail-hero__tags">
