{*+**********************************************************************************
 * HelpDesk Ticket Edit/Create (SUPPORT app): dashboard split shell + topbar.
 ************************************************************************************}
...
<div id="mk-dash-split-root" class="mk-dash-split-root" data-mk-dash-split-root="1" data-mk-helpdesk-edit="1">
	...
	<div class="mk-app-shell">
		...
		<main class="mk-dash-main mk-content mk-hd-edit-main" id="mk-dash-main" role="main">
		<div class="main-container main-container-{$MODULE} mk-hd-edit-page">
			...
			<div class="editViewContainer viewContent clearfix mk-hd-edit-inner">
				<div class="mk-hd-edit-body">
{/strip}
{else}
