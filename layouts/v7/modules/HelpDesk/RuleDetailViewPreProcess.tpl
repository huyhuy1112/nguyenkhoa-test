{*+**********************************************************************************
 * HelpDesk Rule detail (SUPPORT app): dashboard split shell + topbar.
 ************************************************************************************}
...
<div id="mk-dash-split-root" class="mk-dash-split-root" data-mk-dash-split-root="1" data-mk-helpdesk-rule-detail="1">
	...
	<div class="mk-app-shell">
		...
		<main class="mk-dash-main mk-content mk-hd-rule-detail-main" id="mk-dash-main" role="main">
		<div class="main-container main-container-{$MODULE} mk-hd-rule-detail-page">
			...
			<div class="listViewPageDiv content-area full-width mk-hd-rule-detail-content" id="listViewContent">
{/strip}
{else}
