...
{/if}
{if $MK_RB_TOOLS}
	<div class="mk-rb-page mk-so-page mk-opportunity-page">
		{include file="partials/RecycleBinToolsListHeader.tpl"|vtemplate_path:$MODULE}
		<div class="mk-so-table-card mk-opportunity-table-card mk-rb-table-card">
			{capture name=mk_rb_tools_lv}
{/if}
	...
	<div class="col-sm-12 col-xs-12">
		...
		<input type="hidden" id="totalCount" value="{if isset($LISTVIEW_COUNT)}{$LISTVIEW_COUNT}{else}0{/if}" />
							...
							{if $LISTVIEW_ENTRIES_COUNT eq '0'}
								<tr class="emptyRecordsDiv">
									...
									<td colspan="{$COLSPAN_WIDTH}">
										<div class="emptyRecordsContent mk-rb-empty-records">
