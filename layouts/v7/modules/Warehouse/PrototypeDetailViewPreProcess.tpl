{*+**********************************************************************************
 * Warehouse Prototype Detail (Inventory app): dashboard split shell + topbar.
 ************************************************************************************}
...
<link rel="stylesheet" type="text/css" href="{vresource_url('layouts/v7/modules/Warehouse/resources/WarehousePrototype.css')}?mk_v=20260602_inv_proto20" />
<script type="text/javascript" src="{vresource_url('layouts/v7/modules/Vtiger/resources/DashboardSidebarNav.js')}"></script>
<div id="mk-dash-split-root" class="mk-dash-split-root" data-mk-dash-split-root="1" data-mk-warehouse-prototype-detail="1">
	...
	<div class="mk-app-shell">
		...
		<div class="main-container main-container-{$MODULE} mk-wh-proto-page">
			<div class="viewContent mk-wh-proto-inner" id="mkWhPrototypeDetailRoot">
{/strip}
{else}
