{* Project Detail header — MANAGEMENT hero shell *}
{strip}
{if (isset($SELECTED_MENU_CATEGORY) && $SELECTED_MENU_CATEGORY eq 'MANAGEMENT') || (isset($smarty.get.app) && $smarty.get.app eq 'MANAGEMENT')}
<div class="detailview-header-block mk-project-detail-hero-strip">
	<div class="detailview-header mk-project-detail-hero">
		<div class="mk-project-detail-hero__row row">
