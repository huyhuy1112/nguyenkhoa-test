{* Potentials — add/edit tags modal (styled) *}
{strip}
     <div class="showAllTagContainer hide">
        <div class="modal-dialog modal-lg mk-opp-tags-modal-dialog">
            <div class="modal-content mk-opp-tags-modal">
                <form class="detailShowAllModal">
                    ...
                    <div class="modal-body mk-opp-tags-modal__body">
                        <div class="row">
                            <div class="col-lg-6 selectTagContainer">
                                <div class="form-group">
                                    <label class="control-label mk-opp-tags-modal__label">
                                        {vtranslate('LBL_CURRENT_TAGS',$MODULE)}
                                    </label>
                                    <div class="currentTagScroll mk-opp-tags-modal__scroll">
                                        <div class="currentTag multiLevelTagList mk-opp-tags-modal__grid">
                                            <span class="noTagsPlaceHolder mk-opp-tags-empty" style="display:none;">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu currentTagMenu">
                                            <div class="scrollable" style="max-height:300px">
                                                ...
                                                <li class="tag-item list-group-item">
                                                    <span class="noTagExistsPlaceHolder mk-opp-tags-empty">
                                                       {vtranslate('LBL_NO_TAG_EXISTS',$MODULE)}
                                                    </span>
                                                </li>
                                                </ul>
