				...
				<table class="mk-leads-table" id="mk-opps-table">
					<thead>
						<tr>
							...
							<th class="mk-leads-th" scope="col">{vtranslate('LBL_CONTACT_NAME', 'Potentials')}</th>
							...
							<th class="mk-leads-th" scope="col">{vtranslate('LBL_EXPECTED_CLOSE_DATE', 'Potentials')}</th>
