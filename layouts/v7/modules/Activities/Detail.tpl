{strip}
<div class="container-fluid activities-page activities-detail-wrapper" style="padding:18px;">
    <div class="panel panel-default activities-card" style="border-radius:12px; box-shadow:0 12px 30px rgba(15,23,42,0.15);">
