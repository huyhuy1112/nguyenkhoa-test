	...
	<div class="mk-so-page mk-so-list-sales-root mk-leads-page mk-leads-page--lovable mk-contacts-page">
		...
		<div class="mk-leads-filters-card" role="region" aria-label="{vtranslate('LBL_FILTERS', 'Vtiger')}">
			<div class="mk-leads-filters-top">
				...
				<button type="button" class="mk-leads-btn mk-leads-btn--outline mk-leads-filters-toggle" id="mk-contacts-filters-toggle" aria-expanded="true">
			...
			<div id="mk-contacts-filters-panel" class="mk-leads-filters-panel"></div>
		</div>
				...
				<table class="mk-leads-table" id="mk-contacts-table">
					<thead>
						<tr>
							...
							<th class="mk-leads-th" scope="col">{vtranslate('Email', 'Contacts')}</th>
							...
							<th class="mk-leads-th" scope="col">{vtranslate('LBL_TAGS', 'Vtiger')}</th>
