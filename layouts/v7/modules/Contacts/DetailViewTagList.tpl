{* Contacts SALES — tag strip + modals (Lovable chips, BA Excel whitelist) *}
<div class="tagContainer mk-contact-tag-container">
    <div class="tag-contents {if empty($TAGS_LIST)} hide{/if}">
        <div class="detailTagList" data-num-of-tags-to-show="{Vtiger_Tag_Model::NUM_OF_TAGS_DETAIL}">
            ...
            <a href="javascript:void(0);" class="moreTags mk-contact-tags-more {if php7_count($TAGS_LIST) <= Vtiger_Tag_Model::NUM_OF_TAGS_DETAIL } hide {/if}">
    ...
    <div id="addTagContainer">
        <a id="addTagTriggerer" class="badge mk-contact-add-tag-btn">
            <i class="fa fa-plus"></i>
            {vtranslate('LBL_ADD_NEW_TAG',$MODULE)}
        </a>
    </div>
    <div class="viewAllTagsContainer hide">
        <div class="modal-dialog mk-contact-tags-modal-dialog mk-contact-tags-modal-dialog--view">
            <div class="modal-content mk-contact-tags-modal">
                ...
                <div class="modal-body mk-contact-tags-modal__body detailShowAllModal">
                    <div class="mk-contact-tags-modal__grid mk-contact-tags-modal__grid--view currentTag multiLevelTagList">
