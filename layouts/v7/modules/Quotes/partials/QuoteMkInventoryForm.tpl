{* Stock Inventory edit form body only — same field names, IDs, and Save hooks as Inventory/EditView.tpl *}
{strip}
<form class="form-horizontal recordEditView" id="EditView" name="edit" method="post" action="index.php" enctype="multipart/form-data">
	<div class="editViewBody">
		<div class="editViewContents">
			...
			<input type="hidden" name="isDuplicate" value="{if !empty($IS_DUPLICATE)}true{else}false{/if}" />
