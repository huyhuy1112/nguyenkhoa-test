{* Leads SummaryViewWidgets — SALES: 3-column widget grid (profile | activity | related). *}
{strip}
...
{if (isset($SELECTED_MENU_CATEGORY) && $SELECTED_MENU_CATEGORY eq 'SALES') || (isset($smarty.get.app) && $smarty.get.app eq 'SALES')}
	<div class="mk-lead-detail-summary-grid mk-lead-detail-summary-grid--3col">
		...
		<div class="mk-lead-detail-summary-stack mk-lead-detail-summary-stack--center">
