{*+**********************************************************************************
 * GoodsIssue Outbound Edit (Inventory app): dashboard split shell + topbar.
 ************************************************************************************}
...
<div id="mk-dash-split-root" class="mk-dash-split-root" data-mk-dash-split-root="1" data-mk-goodsissue-edit="1">
	...
	<div class="mk-app-shell">
		...
		<main class="mk-dash-main mk-content mk-go-edit-main" id="mk-dash-main" role="main">
		<div class="main-container main-container-{$MODULE} mk-go-edit-page">
			<div id="modnavigator" class="module-nav mk-go-edit-hide-legacy">
				<div class="mod-switcher-container">
					{include file="partials/Menubar.tpl"|vtemplate_path:$MODULE}
				</div>
			</div>
			<div id="sidebar-essentials" class="sidebar-essentials hide mk-go-edit-hide-legacy">
				{include file="partials/SidebarEssentials.tpl"|vtemplate_path:$MODULE}
			</div>
			<div class="editViewContainer viewContent clearfix mk-go-edit-inner">
				<div class="mk-go-edit-body">
{/strip}
{else}
