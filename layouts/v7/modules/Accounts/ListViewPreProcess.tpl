...
window.__mkSalesPosListConfig = {
	...
	searchFields: ['accountname', 'account_no', 'phone', 'email1', 'website', 'assigned_user_id']
};
...
<script type="text/javascript" src="{vresource_url('layouts/v7/modules/Accounts/resources/AccountsList.js')}?mk_v=20260710_pos2"></script>
