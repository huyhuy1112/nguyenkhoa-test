...
window.app = (function () {
	...
	return {
      ...
      // Main Page (Home) dùng Index controller để có menu toggle và app trigger
      if (
        module == "Home" &&
        view == "MainPage" &&
        typeof window["Vtiger_Index_Js"] != "undefined"
      ) {
        return "Vtiger_Index_Js";
			}
      // Reports Management: không có Reports_Management_Js → dùng Vtiger_Index_Js để menu hamburger hoạt động
      if (
        module == "Reports" &&
        view == "Management" &&
        typeof window["Vtiger_Index_Js"] != "undefined"
